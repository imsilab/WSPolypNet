...
from model import R3D18Binary, count_trainable_parameters
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train one-logit Kinetics-pretrained R3D-18 and evaluate CAM CorLoc."
    )
...
def main() -> int:
    ...
    model = R3D18Binary(pretrained=args.resume is None).to(device)
