...
from model import R2Plus1D18Binary, count_trainable_parameters
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train one-logit Kinetics-pretrained R(2+1)D-18 and evaluate CAM CorLoc."
    )
...
def main() -> int:
    ...
    model = R2Plus1D18Binary(pretrained=args.resume is None).to(device)
