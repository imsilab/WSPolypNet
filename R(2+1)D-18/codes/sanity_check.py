...
def first_backbone_parameter(model: R2Plus1D18Binary) -> torch.nn.Parameter:
    return next(
        parameter
...
def main() -> int:
    ...
    model = R2Plus1D18Binary(pretrained=True).to(device)
    ...
    print("R(2+1)D-18 whole-video forward: OK")
