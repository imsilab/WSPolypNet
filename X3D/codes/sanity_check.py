...
def first_backbone_parameter(model: X3DMBinary) -> torch.nn.Parameter:
    return next(
        parameter
...
def main() -> int:
    ...
    model = X3DMBinary(pretrained=True).to(device)
    ...
    print("X3D-M whole-video forward: OK")
