...
from model import X3DMBinary, count_trainable_parameters
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train one-logit Kinetics-pretrained X3D-M and evaluate CAM CorLoc."
    )
...
def main() -> int:
    ...
    model = X3DMBinary(pretrained=args.resume is None).to(device)
